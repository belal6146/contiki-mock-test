...
const ViewSwitch: React.FC<ViewSwitchProps> = ({ currentView, onViewChange }) => {
  return (
    <div className={styles.viewSwitch}>
      <p className={styles.viewSwitchText}>View:</p>
      <div className={styles.viewSwitchWrapper}>
        <button
          className={`${styles.viewSwitchButton} ${currentView === 'list' ? styles.active : ''}`}
        ...
        <button
          className={`${styles.viewSwitchButton} ${currentView === 'calendar' ? styles.active : ''}`}
        ...
        >
          ...
          >
            <path
              d="M2.8,19.6h15.4V8.8H2.8V19.6z M13.8,9.9H16v2.2h-2.2V9.9z M9.4,9.9h2.2v2.2H9.4V9.9z M5,9.9h2.2v2.2H5V9.9z"
            />
            <rect x="13.8" y="9.9" width="2.2" height="2.2" />
            <rect x="5" y="9.9" width="2.2" height="2.2" />
            <rect x="9.4" y="9.9" width="2.2" height="2.2" />
            <path
              d="M18.2,2.4h-1.1V0.2h-2.2v2.2H6.1V0.2H3.9v2.2H2.8c-1.2,0-2.2,1-2.2,2.2l0,15.1c0,1.2,1,2.2,2.2,2.2h15.4c1.2,0,2.2-1,2.2-2.2V4.5C20.4,3.4,19.4,2.4,18.2,2.4z M18.2,19.6H2.8V8.8h15.4V19.6z M18.2,6.7H2.8V4.5h15.4V6.7z"
            />
          </svg>
        </button>
      </div>
