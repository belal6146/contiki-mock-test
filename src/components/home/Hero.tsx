    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-40">
      ...
      <div className="relative z-10 text-center text-white max-w-screen-xl mx-auto px-4 lg:px-8">
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black mb-8 tracking-tight leading-none uppercase">
          TRAVEL FOR
          <br />
          <span className="text-secondary font-black">18-35S</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          <Link
            to="/tours"
            className="bg-secondary text-gray-800 font-black px-12 py-5 rounded-lg text-lg uppercase tracking-wider hover:bg-secondary-dark transition-all duration-200 transform hover:scale-105 shadow-lg"
          >
            FIND YOUR TRIP
          </Link>
          ...
          <Link
            to="/destinations"
            className="border-2 border-white text-white font-black px-12 py-5 rounded-lg text-lg uppercase tracking-wider hover:bg-white hover:text-gray-800 transition-all duration-200 shadow-lg"
          >
