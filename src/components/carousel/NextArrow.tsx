...
const NextArrow: React.FC<NextArrowProps> = ({
  ...
  const getStyles = () => {
    const baseStyles = "absolute right-0 top-1/2 -translate-y-1/2 z-10 transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent";
