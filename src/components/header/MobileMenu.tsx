      ...
      <div className="container max-w-7xl mx-auto py-6 px-4">
        <div className="flex flex-col space-y-6">
            ...
            <MenuLink to="/destinations" label="DESTINATIONS" hasDropdown isMobile onClick={onLinkClick}>
              {destinationItems.map((item, index) => (
                <Link 
                  key={index}
                  to={item.to} 
                  className="block py-2 text-sm text-gray-700 hover:text-black transition-all duration-150 ease-in-out"
          ...
          <div className="space-y-2 pt-4 border-t border-gray-200">
            <Link to="/contact-us" className="block py-2 text-sm text-gray-600 hover:text-black transition-all duration-150 ease-in-out" onClick={() => onLinkClick('Contact us')}>Contact us</Link>
            <Link to="/future-travel-credit" className="block py-2 text-sm text-gray-600 hover:text-black transition-all duration-150 ease-in-out" onClick={() => onLinkClick('Future Travel Credit')}>Future Travel Credit</Link>
            <Link to="/subscribe" className="block py-2 text-sm text-gray-600 hover:text-black transition-all duration-150 ease-in-out" onClick={() => onLinkClick('Subscribe to emails')}>Subscribe to emails</Link>
            <Link to="/login" className="block py-2 text-sm text-gray-600 hover:text-black transition-all duration-150 ease-in-out" onClick={() => onLinkClick('Traveller log in')}>Traveller log in</Link>
            <Link to="/agent-login" className="block py-2 text-sm text-gray-600 hover:text-black transition-all duration-150 ease-in-out" onClick={() => onLinkClick('Agent log in')}>Agent log in</Link>
          </div>
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200">
            ...
            <Link 
              to="/subscribe" 
              className="flex items-center justify-center px-4 py-3 bg-[#CCFF00] rounded-full text-black font-bold text-sm hover:bg-[#b8e600] transition-all duration-150 ease-in-out"
